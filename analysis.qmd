...
```{r}
sales2014 <- read_excel("Excel test juha paallysaho.xlsx", sheet = 2, range = cell_cols("A:C")) |> janitor::clean_names()

mapping <- read_excel("Excel test juha paallysaho.xlsx", sheet = 3) |> janitor::clean_names()
```
